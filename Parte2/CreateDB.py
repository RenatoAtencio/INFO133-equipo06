...
cur.execute("CREATE TABLE Comuna (ComunaID VARCHAR(225), NombreComuna VARCHAR(225), Superficie INT,Poblacion INT,PosiblesTrabajadores INT,TrabajadoresM INT,TrabajadoresF INT, NombreRegion VARCHAR(225),PRIMARY KEY (ComunaID),FOREIGN KEY(NombreRegion) REFERENCES Region(NombreRegion))")
